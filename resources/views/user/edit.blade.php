            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update',$user->id) }}">
                        ...
                        <div class="row mb-3">
                            <label for="hp" class="col-md-4 col-form-label text-md-end">Phone Number</label>

                            <div class="col-md-6">
                                <input id="hp" type="number" class="form-control @error('hp') is-invalid @enderror" name="hp" value="{{ old('hp',$user->hp) }}" required autocomplete="hp" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" value="{{old('password_confirmation',$user->password)}}">
                            </div>
                        </div>
