                            ...
                            <div class="row g-3">
                                <div class="col-md">
                                    ...
                                    <input type="text" name="code" class="form-control @error('code') is-invalid @enderror  @if(old('code') && !$errors->has('code')) is-valid @endif"
                                        id="code" placeholder="*SCAB07" value="{{old('code',$products->code)}}">
                                    @error('code')
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group has-validation">
                                        ...
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror @if(old('name') && !$errors->has('name')) is-valid @endif"
                                            id="name" placeholder="*Hot Bread" value="{{old('name',$products->name)}}">
                                        @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input type="file" name="img" class="form-control @error('img') is-invalid @enderror"
                                        id="img" accept="image/*" value="{{$products->img}}">
                                    @error('img')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select @error('type_id') is-invalid @enderror @if(old('type_id') && !$errors->has('type_id')) is-valid @endif" id="type_id" name="type_id">
                                        ...
                                        @foreach ($types as $type)
                                            <option value="{{$type->id}}" @if(old('type_id',$products->type_id) == $type->id) selected @endif>{{$type->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('type_id')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="price" class="form-control @error('price') is-invalid @enderror @if(old('price') && !$errors->has('price')) is-valid @endif"
                                        id="price" placeholder="*00000" value="{{old('price',$products->price)}}">
                                    @error('price')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="stok" class="form-control @error('stok') is-invalid @enderror @if(old('stok') && !$errors->has('stok')) is-valid @endif"
                                        id="stok" placeholder="*000" value="{{old('stok',$products->stok)}}">
                                    @error('stok')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <textarea type="text-area" name="note" class="form-control @error('note') is-invalid @enderror @if(old('note') && !$errors->has('note')) is-valid @endif" cols="40" rows="5"
                                        id="note" placeholder="........">{{old('note',$products->note)}}</textarea>
                                    @error('note')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary" type="submit">Update &nbsp;<i
                                            class="fas fa-pen-fancy"></i></button>
                                </div>
                            </div>
                        </form>
                        <br>
